...
const ko: LocaleContent = {
  ...
  testimonials: {
    ...
    'Golden Tay': {
      ...
      quote: 'waai에서 가장 인상 깊었던 점은 단순한 챗봇을 훨씬 뛰어넘는다는 것입니다. 기업과 고객이 이미 매일 사용하는 커뮤니케이션 채널인 WhatsApp에 AI를 가져왔습니다. 스마트 비즈니스 어시스턴트로서 waai는 기업이 문의에 응답하고, 지식을 공유하며, 고객과 더 일관되게 소통하도록 돕습니다. 말레이시아 중소기업에 강한 잠재력을 지닌 실용적인 AI 솔루션이라고 생각합니다.',
    },
  },
