...
const ja: LocaleContent = {
  ...
  testimonials: {
    ...
    'Golden Tay': {
      ...
      quote: 'waaiで最も印象的だったのは、チャットボットをはるかに超える存在だという点です。企業と顧客がすでに毎日使っているコミュニケーションチャネルであるWhatsAppにAIを持ち込みました。スマートビジネスアシスタントとして、waaiは問い合わせへの対応、ナレッジの共有、顧客との関係構築をより一貫したものにします。マレーシアの中小企業に大きな可能性を持つ実用的なAIソリューションだと考えています。',
    },
  },
